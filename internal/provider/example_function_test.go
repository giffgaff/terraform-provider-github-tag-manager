		...
		Steps: []resource.TestStep{
			{
				Config: `
				output "test" {
					value = provider::googleTagManager::example("testvalue")
				}
				`,
		...
		Steps: []resource.TestStep{
			{
				Config: `
				output "test" {
					value = provider::googleTagManager::example(null)
				}
				`,
		...
		Steps: []resource.TestStep{
			{
				...
				output "test" {
					value = provider::googleTagManager::example(terraform_data.test.output)
				}
				`,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckOutput("test", "testvalue"),
